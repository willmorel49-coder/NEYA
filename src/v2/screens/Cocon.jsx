    ...
    >
      ...
      {profile.mantra ? (
        <button
          ...
          style={{
            ...
            left: 22,
            right: 22,
            bottom: 'max(374px, calc(env(safe-area-inset-bottom, 0px) + 310px))',
        ...
        <button
          ...
          style={{
            ...
            bottom: 'max(378px, calc(env(safe-area-inset-bottom, 0px) + 314px))',
            appearance: 'none',
            background: 'transparent',
            border: 'none',
            cursor: 'pointer',
      ...
      {currentTrack && (
        <button
          ...
          style={{
            ...
            left: 22,
            right: 22,
            bottom: 'max(314px, calc(env(safe-area-inset-bottom, 0px) + 250px))',
            display: 'flex',
            alignItems: 'center',
            gap: 12,
            padding: '10px 14px',
      ...
      <button
        ...
        style={{
          ...
          left: '50%',
          transform: 'translateX(-50%)',
          bottom: 'max(202px, calc(env(safe-area-inset-bottom, 0px) + 138px))',
          appearance: 'none',
          padding: '16px 38px',
          minHeight: 52,
          background: accent,
      ...
      <button
        ...
        style={{
          ...
          left: '50%',
          transform: 'translateX(-50%)',
          bottom: 'max(264px, calc(env(safe-area-inset-bottom, 0px) + 200px))',
          appearance: 'none',
          background: 'transparent',
          border: 'none',
          cursor: 'pointer',
